...
const Footer = () => {
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
    className: "md:w-full md:flex-wrap md:flex md:justify-between md:px-56 md:py-8 border-t-2 border-gray-200",
    ...
    }, item.title)), /*#__PURE__*/(0,jsx_runtime_.jsxs)("p", {
...
var __webpack_exports__ = __webpack_require__.X(0, [922,664,586,292], () => (__webpack_exec__(380)));
